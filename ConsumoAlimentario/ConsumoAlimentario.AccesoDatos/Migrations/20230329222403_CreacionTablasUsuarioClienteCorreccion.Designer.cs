...
namespace ConsumoAlimentario.AccesoDatos.Migrations
{
    ...
    [Migration("20230329222403_CreacionTablasUsuarioClienteCorreccion")]
    partial class CreacionTablasUsuarioClienteCorreccion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsumoAlimentario.Models.Usuario", b =>
                {
                    b.HasOne("ConsumoAlimentario.Models.Cliente", "Cliente")
                        .WithOne("Usuario")
                        .HasForeignKey("ConsumoAlimentario.Models.Usuario", "Cliente_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
