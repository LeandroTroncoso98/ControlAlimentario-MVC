...
namespace ConsumoAlimentario.AccesoDatos.Migrations
{
    ...
    [Migration("20230406144803_CreacionTablaObjetivoDiario")]
    partial class CreacionTablaObjetivoDiario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsumoAlimentario.Models.ObjetivoDiario", b =>
                {
                    b.Property<int>("ObjetivoDiario_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ObjetivoDiario_Id"));

                    b.Property<double>("AzucarObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("CalcioObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("CaloriasObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("CarbohidratosObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("FibrasObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("GrasasObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("HierroObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("PotasioObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("ProteinasObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("SodioObjetivo")
                        .HasColumnType("float");

                    b.Property<int>("Usuario_Id")
                        .HasColumnType("int");

                    b.Property<double>("VitaminaAObjetivo")
                        .HasColumnType("float");

                    b.Property<double>("VitaminaCObjetivo")
                        .HasColumnType("float");

                    b.HasKey("ObjetivoDiario_Id");

                    b.ToTable("ObjetivoDiario");
                });
            ...
            modelBuilder.Entity("ConsumoAlimentario.Models.Usuario", b =>
                {
                    b.HasOne("ConsumoAlimentario.Models.ObjetivoDiario", "ObjetivoDiario")
                        .WithMany()
                        .HasForeignKey("ObjetivoDiario_Id");

                    b.Navigation("ObjetivoDiario");
                });
